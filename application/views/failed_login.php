...
<div id="container">
    ...
    <div id="content">
        <form id="loginForm" method="post" action="<?php echo base_url("login/user");?>">
            <table id = "table">
                <tr>
                    <td>EmailId: </td>
                ...
                <tr>
                    <td><a href="<?php echo base_url("/register") ?>">Register</a></td>
                    <td><input type="submit" class="button"></td>
                </tr>
                <tr>
                    <td></td>
                    <td><p>Invalid Email ID or Password</p></td>
                </tr>
            </table>
        </form>
    </div>
